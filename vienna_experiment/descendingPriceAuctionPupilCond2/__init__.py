...
class Player(BasePlayer):
    ...
    frage = models.StringField(
    blank=True, 
    null=True,
    label= 'Was glauben Sie, wofür Ihre Blickdaten verwendet wurden?'
)
    ...
    def get_plot(self): # 
        self.participant.vars["graph"] = {'left': random.random(), 'right': random.random()} 
...
page_sequence = [Anleitung, BidWaitPage, Bid, ResultsWaitPage, Results, Frage]


def updatePUPIL_Visualization(player, left, right):
